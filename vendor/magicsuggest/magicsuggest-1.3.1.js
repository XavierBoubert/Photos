        ...
        var self = {
            ...
            _renderComboItems: function(items, isGrouped) {
                ...
                $.each(items, function(index, value) {
                    ...
                    var resultItemEl = $('<div/>', {
                        'class': 'ms-res-item ' + (value.cls ? value.cls : '') + ' ' + (isGrouped ? 'ms-res-item-grouped ':'') +
            ...
            _renderSelection: function() {
                ...
                $.each(_selection, function(index, value){
                    ...
                    if(asText === true) {
                        selectedItemEl = $('<div/>', {
                            'class': 'ms-sel-item ms-sel-text ' + (value.cls ? value.cls : '') + ' ' + cfg.selectionCls,
                            html: selectedItemHtml + (index === (_selection.length - 1) ? '' : ',')
                        }).data('json', value);
                    }
                    else {
                        selectedItemEl = $('<div/>', {
                            'class': 'ms-sel-item ' + (value.cls ? value.cls : '') + ' ' + cfg.selectionCls,
